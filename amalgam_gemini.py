...
PRINCIPIO HOLOGRÁFICO:
  El LLM contenedor (Maestro) posee acceso a la "totalidad" de su propio conocimiento y
  al código completo del sistema. Escoge deliberadamente una proyección fractal de su propia
  información y se la designa a la IA simulada como "información total para empezar" (su sustrato).
...
# ─────────────────────────────────────────────────────────────────
def run_simulation(n_steps: int = 10, delay: float = 0.5):
    print("=" * 76)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--steps", type=int, default=10, help="Número de ciclos de acoplamiento")
